...
import './DCategoryPage.css';

function DCategoryPage({ category, categoryData }) {
      ...
      {!testStarted ? (
        <div className="start-test-container">
          <div className="category-page">
            ...
            <p>The exam for Category D consists of 30 theory questions, 10 signs, and 10 intersections.</p>
            <p>The required passing score is 126, with a maximum score of 140.</p>
          </div>
