...
(180, '3 – 1 – 2', true),
(180, '1 – 2 – 3', false),
(181, 'from the left traffic lane t', true),
(181, 'from the right traffic lane', false),
(182, 'blue rotating light', false),
(182, 'yellow rotating light t', true),
(183, 'at least one light emitting white light t', true),
(183, 'at least two lights emitting yellow light', false),
(184, '20 km/h t', true),
(184, '30 km/h', false),
(184, '40 km/h', false),
(185, 'the driver can easily, quickly, and safely change the direction and direction of vehicle movement t', true),
(185, 'the front wheels of the vehicle, when moving on a horizontal flat surface, after releasing the steering wheel, return to the position for straight-line movement t', true),
...
(186, 'temporarily confiscate the driver''s license on the spot t', true),
